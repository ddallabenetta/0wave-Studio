...
export const it: typeof en = {
  ...
  playground: {
    transport: {
      ...
      countIn: "Conteggio",
      loop: "Loop",
      loopFromBar: "Loop dalla battuta",
      loopBars: "Battute",
      position: "Posizione",
      spaceHint: "Spazio = play / pausa",
    },
    empty: {
    ...
    pattern: {
      ...
      gate: "Gate",
      preview: "Anteprima",
      audition: "Ascolta questo pattern",
      auditionStop: "Ferma",
      notes: "note",
      empty: "Ancora nessuna nota",
      playsOn: "Suona su",
      playsOnHint: "Un pattern suona con lo strumento della traccia su cui si trova. Mettilo su un'altra traccia e suonerà quello strumento.",
      unplaced: "Non è ancora su una traccia",
      unplacedHint: "Mettilo su una traccia per decidere quale strumento lo suona.",
      placeHere: "Metti sulla traccia selezionata",
      trackHasNoSound: "Questa traccia non ha ancora un suono",
      choosePattern: "Scegli un pattern",
      octaveUp: "Mostra un'ottava più su",
      octaveDown: "Mostra un'ottava più giù",
      notesAbove: "note sopra questa finestra",
      notesBelow: "note sotto questa finestra",
      newPatternHere: "Nuovo pattern su questa traccia",
      bars: "{n} battute",
      gridHint:
    ...
    timeline: {
      snap: "Griglia",
      zoom: "Zoom",
      seekHint: "Clicca il righello delle battute per spostare la testina.",
      bar: "Battuta",
      duplicateClip: "Duplica clip",
