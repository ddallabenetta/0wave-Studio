...
export const en = {
  ...
  playground: {
    ...
    pattern: {
      ...
      gate: "Gate",
      preview: "Preview",
      audition: "Hear this pattern",
      auditionStop: "Stop",
      notes: "notes",
      empty: "No notes yet",
      playsOn: "Plays on",
      playsOnHint: "A pattern sounds through the track it sits on. Drop it on another track and it plays that instrument instead.",
      unplaced: "Not on a track yet",
      unplacedHint: "Place it on a track to choose which instrument plays it.",
      placeHere: "Place on selected track",
      trackHasNoSound: "This track has no sound yet",
      choosePattern: "Choose a pattern",
      octaveUp: "Show an octave higher",
      octaveDown: "Show an octave lower",
      notesAbove: "notes above this window",
      notesBelow: "notes below this window",
      newPatternHere: "New pattern on this track",
    ...
    timeline: {
      snap: "Snap",
      zoom: "Zoom",
      seekHint: "Click the bar ruler to move the playhead.",
      bar: "Bar",
